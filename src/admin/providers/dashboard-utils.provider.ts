...
export class DashboardUtilsProvider {
  ...
  public async getPostgresVersion(): Promise<string> {
    return await this.cache.getOrCache('DASHBOARD_POSTGRES_VERSION', async () => {
  ...
  public async getImageMagickVersion(): Promise<string> {
    return await this.cache.getOrCache('DASHBOARD_IMAGEMAGICK_VERSION', async () => {
  ...
  public async getFfMpegVersion(): Promise<string> {
    return await this.cache.getOrCache('DASHBOARD_FFMPEG_VERSION', async () => {
  ...
  public async getPgDumpVersion(): Promise<string> {
    return await this.cache.getOrCache('DASHBOARD_PG_DUMP_VERSION', async () => {
  ...
  public async getZipVersion(): Promise<string> {
    return await this.cache.getOrCache('DASHBOARD_ZIP_VERSION', async () => {
